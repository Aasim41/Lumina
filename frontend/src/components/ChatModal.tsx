            ...
            <div className="p-4 border-t border-white/10 bg-white/5">
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white hover:bg-primary-hover disabled:opacity-50 transition-colors shrink-0"
                >
